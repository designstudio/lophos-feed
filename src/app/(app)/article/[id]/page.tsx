              ...
              <article className="animate-fade-in">
                ...
                {item.videoUrl ? (
                  ...
                  <button
                    ...
                    className="w-full rounded-[1rem] overflow-hidden mb-6 bg-bg-secondary relative shadow-md hover:shadow-2xl transition-all duration-300 cursor-zoom-in group hover:scale-105"
                    style={{ transformOrigin: 'center' }}
                  >
                    <img src={`/api/image-proxy?url=${encodeURIComponent(item.imageUrl)}`} alt={item.title} className="article-image w-full transition-transform duration-300"
