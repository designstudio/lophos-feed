...
export function ZoomableEditorialImage({ src, alt, credit, imageClassName }: {
  src: string
  alt: string
  credit?: string
  ...
  return (
    <>
      ...
      >
        <span className="block overflow-hidden rounded-[1.5rem] shadow-md transition-transform duration-150 group-hover:scale-[1.02] group-hover:shadow-lg">
          {/* Uploaded editorial URLs are generated by the trusted admin API. */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={src} alt={alt} className={cn('h-auto w-full', imageClassName)} />
        </span>
        {credit ? (
          <span
