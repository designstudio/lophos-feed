        ...
        <div className="mx-auto max-w-[980px]">
          <article className="mx-auto max-w-[760px]">
            ...
            {unstyledContent ? (
              ...
              <div
                className={cn(
                  'space-y-8 text-body text-ink-secondary [&_a]:text-ink-primary [&_a]:underline [&_a]:underline-offset-2 [&_a]:transition-opacity [&_a:hover]:opacity-65 [&_h2]:mb-3 [&_h2]:font-display [&_h2]:text-2xl [&_h2]:text-ink-primary [&_h3]:mb-2 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:text-ink-primary [&_ol]:list-decimal [&_ol]:space-y-2 [&_ol]:pl-6 [&_p]:leading-relaxed [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-6',
                  contentClassName
                )}
              >
                {children}
